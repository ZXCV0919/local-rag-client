...
export function DataManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-lg border border-[var(--color-danger-border)] bg-[color-mix(in_srgb,var(--badge-error-bg)_35%,var(--color-surface))] p-5 shadow-sm space-y-3">
